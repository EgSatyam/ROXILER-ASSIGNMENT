  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex gap-4">
        <button onClick={()=>setShowCreateUser(true)} className="bg-green-600 text-white px-4 py-2 rounded">Create User</button>
        <button onClick={()=>setShowCreateStore(true)} className="bg-blue-600 text-white px-4 py-2 rounded">Create Store</button>
      </div>
      {showCreateUser && (
        <div className="bg-white p-4 rounded shadow">
          <h4 className="text-lg font-medium mb-4">Create User</h4>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <input placeholder="Name" value={createUserForm.name} onChange={e=>setCreateUserForm({...createUserForm,name:e.target.value})} className="border px-3 py-2 rounded" />
            <input placeholder="Email" value={createUserForm.email} onChange={e=>setCreateUserForm({...createUserForm,email:e.target.value})} className="border px-3 py-2 rounded" />
            <input placeholder="Address" value={createUserForm.address} onChange={e=>setCreateUserForm({...createUserForm,address:e.target.value})} className="border px-3 py-2 rounded" />
            <input type="password" placeholder="Password" value={createUserForm.password} onChange={e=>setCreateUserForm({...createUserForm,password:e.target.value})} className="border px-3 py-2 rounded" />
          ...
          <div className="flex gap-2 mt-4">
            <button onClick={createUser} className="bg-green-600 text-white px-4 py-2 rounded">Create</button>
      ...
      {showCreateStore && (
        <div className="bg-white p-4 rounded shadow">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <input placeholder="Name" value={createStoreForm.name} onChange={e=>setCreateStoreForm({...createStoreForm,name:e.target.value})} required className="border px-3 py-2 rounded" />
            <input placeholder="Email" value={createStoreForm.email} onChange={e=>setCreateStoreForm({...createStoreForm,email:e.target.value})} className="border px-3 py-2 rounded" />
            <input placeholder="Address" value={createStoreForm.address} onChange={e=>setCreateStoreForm({...createStoreForm,address:e.target.value})} className="border px-3 py-2 rounded" />
          ...
          <div className="flex gap-2 mt-4">
            <button onClick={createStore} className="bg-blue-600 text-white px-4 py-2 rounded">Create</button>
